...
public class ScheduleApi {
    ...
    /**
     * Build call for deleteScheduleById
     * @param scheduleId  (required)
     * @param scheduleId Идентификатор расписания (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteScheduleByIdCall(Long scheduleId, String scheduleId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteScheduleByIdValidateBeforeCall(Long scheduleId, String scheduleId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'scheduleId' is set
        if (scheduleId == null) {
            throw new ApiException("Missing the required parameter 'scheduleId' when calling deleteScheduleById(Async)");
        }
        
        com.squareup.okhttp.Call call = deleteScheduleByIdCall(scheduleId, scheduleId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Schedule deleteScheduleById(Long scheduleId, String scheduleId) throws ApiException {
        ApiResponse<Schedule> resp = deleteScheduleByIdWithHttpInfo(scheduleId, scheduleId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Schedule> deleteScheduleByIdWithHttpInfo(Long scheduleId, String scheduleId) throws ApiException {
        com.squareup.okhttp.Call call = deleteScheduleByIdValidateBeforeCall(scheduleId, scheduleId, null, null);
        Type localVarReturnType = new TypeToken<Schedule>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Удалить расписание по ID (asynchronously)
     * Удаляет расписание
     * @param scheduleId  (required)
     * @param scheduleId Идентификатор расписания (optional)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteScheduleByIdAsync(Long scheduleId, String scheduleId, final ApiCallback<Schedule> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteScheduleByIdValidateBeforeCall(scheduleId, scheduleId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Schedule>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
