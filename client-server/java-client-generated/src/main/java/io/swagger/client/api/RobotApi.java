...
public class RobotApi {
     ...
     * @param robotContamination  (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call addRobotCall(Long id, String model, String version, Long charge, Long garbageContainer, Long robotContamination, Long nextService, String serialNumber, Long ipAddress, Long groupId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (robotContamination != null)
        localVarFormParams.put("robotContamination", robotContamination);
        if (nextService != null)
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call addRobotValidateBeforeCall(Long id, String model, String version, Long charge, Long garbageContainer, Long robotContamination, Long nextService, String serialNumber, Long ipAddress, Long groupId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // verify the required parameter 'robotContamination' is set
        if (robotContamination == null) {
            throw new ApiException("Missing the required parameter 'robotContamination' when calling addRobot(Async)");
        }
        ...
        com.squareup.okhttp.Call call = addRobotCall(id, model, version, charge, garbageContainer, robotContamination, nextService, serialNumber, ipAddress, groupId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Robot addRobot(Long id, String model, String version, Long charge, Long garbageContainer, Long robotContamination, Long nextService, String serialNumber, Long ipAddress, Long groupId) throws ApiException {
        ApiResponse<Robot> resp = addRobotWithHttpInfo(id, model, version, charge, garbageContainer, robotContamination, nextService, serialNumber, ipAddress, groupId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Robot> addRobotWithHttpInfo(Long id, String model, String version, Long charge, Long garbageContainer, Long robotContamination, Long nextService, String serialNumber, Long ipAddress, Long groupId) throws ApiException {
        com.squareup.okhttp.Call call = addRobotValidateBeforeCall(id, model, version, charge, garbageContainer, robotContamination, nextService, serialNumber, ipAddress, groupId, null, null);
        Type localVarReturnType = new TypeToken<Robot>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call addRobotAsync(Long id, String model, String version, Long charge, Long garbageContainer, Long robotContamination, Long nextService, String serialNumber, Long ipAddress, Long groupId, final ApiCallback<Robot> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = addRobotValidateBeforeCall(id, model, version, charge, garbageContainer, robotContamination, nextService, serialNumber, ipAddress, groupId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Robot>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateRobotCall(Long id, String model, String version, Long charge, Long garbageContainer, Long robotContamination, Long nextService, String serialNumber, Long ipAddress, Long groupId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateRobotValidateBeforeCall(Long id, String model, String version, Long charge, Long garbageContainer, Long robotContamination, Long nextService, String serialNumber, Long ipAddress, Long groupId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
        ...
        // verify the required parameter 'robotContamination' is set
        if (robotContamination == null) {
            throw new ApiException("Missing the required parameter 'robotContamination' when calling updateRobot(Async)");
        }
        // verify the required parameter 'nextService' is set
        if (nextService == null) {
        ...
        com.squareup.okhttp.Call call = updateRobotCall(id, model, version, charge, garbageContainer, robotContamination, nextService, serialNumber, ipAddress, groupId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Robot updateRobot(Long id, String model, String version, Long charge, Long garbageContainer, Long robotContamination, Long nextService, String serialNumber, Long ipAddress, Long groupId) throws ApiException {
        ApiResponse<Robot> resp = updateRobotWithHttpInfo(id, model, version, charge, garbageContainer, robotContamination, nextService, serialNumber, ipAddress, groupId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Robot> updateRobotWithHttpInfo(Long id, String model, String version, Long charge, Long garbageContainer, Long robotContamination, Long nextService, String serialNumber, Long ipAddress, Long groupId) throws ApiException {
        com.squareup.okhttp.Call call = updateRobotValidateBeforeCall(id, model, version, charge, garbageContainer, robotContamination, nextService, serialNumber, ipAddress, groupId, null, null);
        Type localVarReturnType = new TypeToken<Robot>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateRobotAsync(Long id, String model, String version, Long charge, Long garbageContainer, Long robotContamination, Long nextService, String serialNumber, Long ipAddress, Long groupId, final ApiCallback<Robot> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateRobotValidateBeforeCall(id, model, version, charge, garbageContainer, robotContamination, nextService, serialNumber, ipAddress, groupId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Robot>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
