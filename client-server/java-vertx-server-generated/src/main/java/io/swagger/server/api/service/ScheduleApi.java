...
public interface ScheduleApi  {
    ...
    String OPERATION_ID_DELETESCHEDULEBYID = "deleteScheduleById";
    ...
    void addSchedule(RequestParameter body, ServiceRequest request, Handler<AsyncResult<ServiceResponse>> resultHandler);
    void deleteScheduleById(RequestParameter body, ServiceRequest request, Handler<AsyncResult<ServiceResponse>> resultHandler);
